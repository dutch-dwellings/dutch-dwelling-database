...
FILE_NAME_IN = 'CBS_PC6_2017_v3.csv'
FILE_NAME_OUT = 'CBS_PC6_2017_v3_fixed.csv'
TABLE_NAME = 'cbs_pc6_2017_kerncijfers'
...
def main():
	...
	try:
		print("Loading CBS kerncijfers records, this might take a minute or so.")
		...
		print(f"\nError: CBS kerncijfers data file not found.\nExpected file at {path}.")
