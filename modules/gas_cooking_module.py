...
class GasCookingModule(BaseModule):
	...
	def process(self, dwelling, **kwargs):
		...
		gas_cooking_p = boiler_heating_space_p + district_high_gas_p + district_low_gas_p + elec_high_gas_p + elec_low_gas_p + block_heating_space_p # 0.5 could be improved by looking for literature
